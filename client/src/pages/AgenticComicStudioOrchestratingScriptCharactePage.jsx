...
export default function AgenticComicStudioOrchestratingScriptCharactePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const r = await fetch('/api/cf-agentic-comic-studio-orchestrating-script-characte/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb', maxWidth: 980 }}>
      <h2 style={{ marginTop: 0 }}>Agentic comic studio orchestrating script, character design, panel-layout, and lettering end-to-end</h2>
      <p style={{ color: '#9ca3af', fontSize: 13 }}>
        Endpoint: <code>/api/cf-agentic-comic-studio-orchestrating-script-characte/run</code>. Submit context as text; the backend calls OpenRouter and returns structured JSON.
      </p>
